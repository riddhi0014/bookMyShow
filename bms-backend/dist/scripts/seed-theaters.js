...
const theatre_model_1 = require("../modules/modules/theatre/theatre.model");
...
mongoose_1.default
    ...
    await theatre_model_1.Theatre.deleteMany({});
    await theatre_model_1.Theatre.insertMany(theatres);
