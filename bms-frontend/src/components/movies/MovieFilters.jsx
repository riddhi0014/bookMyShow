...
const MovieFilters = () => {
  return (
    <div className="w-full md:w-1/4 p-4 space-y-6">
      ...
      <button className='w-full border cursor-pointer border-[#f74362] test-[#f74362] py-1 rounded hover:bg-[#f74362] hover:text-white transition'>Browse by Cinemas</button>
    </div> 
  );
};
